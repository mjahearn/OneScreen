...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/images/playerSketch.xcf");
		types.push (AssetType.BINARY);
		
		
		urls.push ("assets/images/tilesheet.xcf");
		types.push (AssetType.BINARY);
		...
		urls.push ("assets/images/bumper.xcf");
		types.push (AssetType.BINARY);
		
		
		urls.push ("assets/images/bumper.png");
		types.push (AssetType.IMAGE);
		...
		urls.push ("assets/maps/testMap.tmx");
		types.push (AssetType.TEXT);
	...
	public static function main () {
		...
		#if js
		#if munit
		flash.Lib.embed (null, 704, 544, "000000");
		#end
		#else
		create ();
		#end
