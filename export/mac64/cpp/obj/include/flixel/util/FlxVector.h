...
class HXCPP_CLASS_ATTRIBUTES  FlxVector_obj : public ::flixel::util::FlxPoint_obj{
	...
	public:
		...
		virtual ::flixel::util::FlxVector subtractNew( ::flixel::util::FlxVector v);
		...
		static ::flixel::util::FlxPool_flixel_util_FlxVector _pool;
		static ::flixel::util::FlxVector _vector1;
		static ::flixel::util::FlxVector _vector2;
		static ::flixel::util::FlxVector _vector3;
		static ::flixel::util::FlxVector get( hx::Null< Float >  X,hx::Null< Float >  Y);
