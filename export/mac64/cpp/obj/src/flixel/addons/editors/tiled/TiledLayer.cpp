...
::openfl::_v2::utils::ByteArray TiledLayer_obj::getByteArrayData( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(62)
	::openfl::_v2::utils::ByteArray result = null();		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(64)
	...
	if (((_g == HX_CSTRING("base64")))){
		...
		HX_STACK_LINE(69)
		::openfl::_v2::utils::ByteArray _g1 = ::flixel::addons::editors::tiled::TiledLayer_obj::base64ToByteArray(chunk);		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(69)
		result = _g1;
		HX_STACK_LINE(70)
...
Array< int > TiledLayer_obj::get_tileArray( ){
	...
	if (((this->tileArray == null()))){
		HX_STACK_LINE(220)
		::openfl::_v2::utils::ByteArray mapData = this->getByteArrayData();		HX_STACK_VAR(mapData,"mapData");
		HX_STACK_LINE(222)
		if (((mapData == null()))){
			HX_STACK_LINE(224)
...
::openfl::_v2::utils::ByteArray TiledLayer_obj::base64ToByteArray( ::String data){
