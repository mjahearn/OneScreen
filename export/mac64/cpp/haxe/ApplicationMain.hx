...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "OneScreen", "com.example.myapp", "0.0.1");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "OneScreen", null, { width: 704, height: 544 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 704, height: 544 });
			#end
